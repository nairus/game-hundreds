$(document).ready(function() {
  ...
  models.createDatas = function() {
    models.BEST_SCORES = "game-hundreds.bestScores";
    models.levelsList = [
      {
        level: 1,
        timeLimit: 1000,
    ...
    // Initialisation des données pour le score
    models.playerName = "nairus"; // FIXME
    models.playerScore = 0;
    models.bestScores = game.functions.getBestScores();
